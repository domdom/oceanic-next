...
call <sid>hi('EndOfBuffer',                s:base05, s:none,   '',          '')
call <sid>hi('LineNr',                     s:base03, s:none,   s:bold,      '')
call <sid>hi('SignColumn',                 s:base00, s:none  , '',          '')
...
call <sid>hi('GitGutterAdd',               s:base00, s:base0B, s:bold,      '')
call <sid>hi('GitGutterChange',            s:base00, s:base0D, s:bold,      '')
call <sid>hi('GitGutterDelete',            s:base00, s:base08, s:bold,      '')
call <sid>hi('GitGutterChangeDelete',      s:base00, s:base0E, s:bold,      '')

call <sid>hi('SignifySignAdd',             s:base00, s:base0B, s:bold,      '')
call <sid>hi('SignifySignChange',          s:base00, s:base0D, s:bold,      '')
call <sid>hi('SignifySignDelete',          s:base00, s:base08, s:bold,      '')
call <sid>hi('SignifySignChangeDelete',    s:base00, s:base0E, s:bold,      '')
call <sid>hi('SignifySignDeleteFirstLine', s:base00, s:base08, s:bold,      '')
